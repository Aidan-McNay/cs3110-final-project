...
list of moves in algebraic notation into a string format with the first element 
...
(** [move_record_to_alg_notation pieces move_record] uses the given [move_record]
to write a string in the English Standard Algebraic Notation format of chess. 
[pieces] is used to disambiguate which piece made the move following the rules 
of Standard Algebraic Notation *)
